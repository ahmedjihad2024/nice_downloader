...
//
// part 'init_hive.dart';part 'models.dart';
//
// class HttpClient {
...
//
//     var fileExtension =
//         contentType != null ? contentType.split('/')[1] : 'none';
//
...
//       {bool waitConnection = false}) async {
//     while (true) {
//       try {
...
//   Future<void> pause();
//
//   StreamSubscription<DownloaderData> listen(
//       Function(DownloaderData downloaderData) callback);
// }
//
...
//   final StreamController<DownloaderData> controller =
//       StreamController<DownloaderData>();
//   DownloaderData data;
...
//     controller.add(data.copyWith(
//         downloadStatus: DOWNLOAD_STATUS.LOADING)); // Initial notification
//
//     // Check internet connectivity
//     var hasInternet = await NetworkUtils.checkInternetConnection(
...
//     try {
//       await _closeDownloadStream();
//       controller.add(data.copyWith(downloadStatus: DOWNLOAD_STATUS.CANCELED));
//       await _closeHttpClient();
//       await _closeFile();
//       await _deleteFile();
//       downloadedBytes = 0;
...
//     controller.add(data.copyWith(downloadStatus: DOWNLOAD_STATUS.COMPLETED));
//     await _closeHttpClient();
//     await _closeFile();
//   }
//
...
//       Future.wait(_downloads.map((d) => d.cancel()));
//
//   Future<void> pauseAll() async =>
//       Future.wait(_downloads.map((d) => d.pause()));
//
//   Future<void> startAll() async =>
//       Future.wait(_downloads.map((d) => d.start()));
//
